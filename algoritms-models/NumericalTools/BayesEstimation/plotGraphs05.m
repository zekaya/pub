function [aposteriori1,aposteriori10,aposteriori100,aposteriori1000,likelihood1,likelihood10,likelihood100,likelihood1000,map1,map10,map100,map1000,ml1,ml10,ml100,ml1000,mmse1,mmse10,mmse100,mmse1000] = plotGraphs05()

syms theta

[aposteriori1,denominator1,likelihood1, apriori1] = bayesEstimation(0.5, 1)
...
[aposteriori10,denominator10,likelihood10, apriori10] = bayesEstimation(0.5, 10);
...
[aposteriori100,denominator100,likelihood100, apriori100] = bayesEstimation(0.5, 100);
...
[aposteriori1000,denominator1000,likelihood1000, apriori1000] = bayesEstimation(0.5, 1000);
e= subs(aposteriori1000, 0:0.001:10);
fig5 =plot(e);
set(fig5, 'Color', [0 1 1]);
set(gca,'XLimMode',['auto']);
set(gca,'YLimMode',['auto']);
hold off
